    ...
    <div class="container-fluid mt-4 " id="create-form">
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://www.kindpng.com/picc/m/109-1097640_student-university-cartoon-hd-png-download.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="cne" type="text" class="form-control"  placeholder="Enter student no">
                            </div>
                            <div class="form-group">
